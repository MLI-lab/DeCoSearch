...
#SBATCH --gres=gpu:4
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment1/logs/experiment1.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment1/logs/experiment1.err
...
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment1/logs/experiment1_cpu.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment1/logs/experiment1_cpu.err
#SBATCH --time=48:00:00
