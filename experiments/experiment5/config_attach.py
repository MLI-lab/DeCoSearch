...
class RabbitMQConfig:
    ...
    """
    host: str = 'mcml-hgx-h100-005.ai.lrz.de' # change to localhost if run from other server than yosemite where rabbitmq container is located 
    port: int = 5694 # to connect on port 5672 need to have tunnel on server script is running to conenct to yosemite ssh -L 5672:localhost:6061 -J ge74met@login01.msv.ei.tum.de:3022 franziska@yosemite.msv.ei.tum.de
