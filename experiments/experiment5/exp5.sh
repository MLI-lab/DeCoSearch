...
#SBATCH --gres=gpu:4
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment5/logs/experiment5.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment5/logs/experiment5.err
...
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment5/logs/experiment5_cpu.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment5/logs/experiment5_cpu.err
#SBATCH --time=48:00:00
