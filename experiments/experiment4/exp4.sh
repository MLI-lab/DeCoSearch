...
#SBATCH --gres=gpu:4
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment4/logs/experiment4.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment4/logs/experiment4.err
...
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment4/logs/experiment4_cpu.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment4/logs/experiment4_cpu.err
#SBATCH --time=48:00:00
