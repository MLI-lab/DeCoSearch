...
class RabbitMQConfig:
    ...
    port: int = 5693 # to connect on port 5672 need to have tunnel on server script is running to conenct to yosemite ssh -L 5672:localhost:6061 -J ge74met@login01.msv.ei.tum.de:3022 franziska@yosemite.msv.ei.tum.de
...
class ProgramsDatabaseConfig:
  ...
  cluster_sampling_temperature_init: float = 0.5 # changed from 0.1 to 1
