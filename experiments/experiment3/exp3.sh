...
#SBATCH --gres=gpu:4
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment3/logs/experiment3.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment3/logs/experiment3.err
...
#SBATCH -o /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment3/logs/experiment3_cpu.out
#SBATCH -e /dss/dsshome1/02/di38yur/Funsearch/experiments/experiment3/logs/experiment3_cpu.err
#SBATCH --time=48:00:00
